...
/* DO NOT EDIT!  -*- buffer-read-only: t -*-  This file is automatically
   generated from "bfd-in.hpp", "init.c", "opncls.c", "libbfd.c",
...
/* General purpose part of a symbol X;
   target specific parts are in libcoff.hpp, libaout.hpp, etc.  */
...
struct bfd_hash_table {
	...
	/* An objalloc for this hash table.  This is a struct objalloc *,
     but we use void * to avoid requiring the inclusion of objalloc.hpp.  */
	void *memory;
};
...
/* NB: This declaration should match the autogenerated one in libbfd.hpp.  */
...
/* Copy ABFD's program header table entries to *PHDRS.  The entries
   ...
   defined in include/elf/internal.hpp.  To find out how large the
