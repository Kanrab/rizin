...
static int check_expected_0(RzJson *j) {
	...
	mu_assert("double value",
		child_1->num.dbl_value < (5.1 + 1.0e-13) && child_1->num.dbl_value > (5.1 - 1.0e-13));
	child_1 = child_1->next;
	mu_assert_notnull(child_1, "array child");
	mu_assert_null(child_1->key, "array child key");
	mu_assert_eq(child_1->type, RZ_JSON_INTEGER, "integer type");
	...
	mu_assert("double value",
		child_0->num.dbl_value < (-1.0e-4 + 1.0e-13) && child_0->num.dbl_value > (-1.0e-4 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "object child");
	mu_assert_notnull(child_0->key, "object child key not null");
...
static int check_expected_6(RzJson *j) {
	...
	mu_assert_streq_free(rz_json_as_string(j, true), "true", "boolean as string");
	return MU_PASSED;
}
...
static int check_expected_7(RzJson *j) {
	...
	mu_assert_streq_free(rz_json_as_string(j, true), "-0.010000", "double as string");
	return MU_PASSED;
}

static int check_expected_8(RzJson *j) {
	mu_assert_eq(j->type, RZ_JSON_NULL, "null type");
	mu_assert_streq_free(rz_json_as_string(j, true), "null", "null as string");
	return MU_PASSED;
}
...
static int check_expected_24(RzJson *j) {
	...
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (1.1999999999999999e-4 + 1.0e-13) && child_0->num.dbl_value > (1.1999999999999999e-4 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "array child");
	mu_assert_null(child_0->key, "array child key");
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (6.0e-6 + 1.0e-13) && child_0->num.dbl_value > (6.0e-6 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "array child");
	mu_assert_null(child_0->key, "array child key");
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	...
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (1.0e-6 + 1.0e-13) && child_0->num.dbl_value > (1.0e-6 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "array child");
	mu_assert_null(child_0->key, "array child key");
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
...
static int check_expected_25(RzJson *j) {
	...
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (10.0 + 1.0e-13) && child_0->num.dbl_value > (10.0 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "array child");
	mu_assert_null(child_0->key, "array child key");
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	...
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (3.141569 + 1.0e-13) && child_0->num.dbl_value > (3.141569 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_notnull(child_0, "array child");
	mu_assert_null(child_0->key, "array child key");
	mu_assert_eq(child_0->type, RZ_JSON_DOUBLE, "double type");
	mu_assert("double value",
		child_0->num.dbl_value < (1000.0 + 1.0e-13) && child_0->num.dbl_value > (1000.0 - 1.0e-13));
	child_0 = child_0->next;
	mu_assert_null(child_0, "last child null");
	return MU_PASSED;
}
...
static int check_expected_58(RzJson *j) {
	...
	char *jsonstr = rz_json_as_string(j, true);
...
static int check_expected_59(RzJson *j) {
	...
	mu_assert_streq_free(rz_json_as_string(j, true), "42", "integer as string");
	return MU_PASSED;
}

static int check_expected_60(RzJson *j) {
	mu_assert_eq(j->type, RZ_JSON_OBJECT, "object type");
