...
bool test_uleb128_big(void) {
	int len;
	ut8 *data = rz_uleb128_encode(9019283812387, &len);
...
bool test_leb128_correctness(void) {
	...
	const ut8 *buf = rz_leb128(data, 2, &val);
